...
public class ChessMatch {
	...
	//Dada determinada cor, devolve o opponent
	...
	//Método responsável por testar se existe a possibilidade de check
	private boolean testCheck(Color color) {
		Position kingPosition = king(color).getChessPosition().toPosition();
		List<Piece> opponnetPieces = piecesOnTheBoard.stream().filter(x -> ((ChessPiece)x).getColor() == opponent(color)).collect(Collectors.toList());
